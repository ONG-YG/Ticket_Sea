...
/**
 * Servlet implementation class ReviewMgrServlet
 */
@WebServlet(name = "ReviewMgr", urlPatterns = { "/reviewMgr.do" })
public class ReviewMgrServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewMgrServlet() {
        super();
