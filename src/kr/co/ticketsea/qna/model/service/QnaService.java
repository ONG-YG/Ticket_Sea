...
public class QnaService {
	...
	public PageData searchList(String keyword, int currentPage) {
		...
		ArrayList<Qna> list = new QnaDao().getSearchCurrentPage(conn,currentPage,recordCountPerPage,keyword);
		String pageNavi = new QnaDao().getSearchPageNavi(conn,currentPage,recordCountPerPage,naviCountPerPage,keyword);
		PageData pd = null;
