...
<%
	...
	ArrayList<PerformSchedule> psList = (ArrayList<PerformSchedule>)request.getAttribute("performSchList");
%>
<head>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('.calendar-date a').click(function(){
                date_sel = null;
                cnt_sel = null;
                $('#cnt_box li').removeClass('selected_cnt_li');
                $('.calendar-date a').removeClass('selected_date_td');
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="calendar-week"> <!-- 달력의 한 주에 해당하는 엘리먼트 컨테이너 -->
                                                        ...
                                                        <td class="calendar-date calendar-sat"><a>13</a></td>
                                                    </tr>
                                                    <tr class="calendar-week"> <!-- 달력의 한 주에 해당하는 엘리먼트 컨테이너 -->
                                                        ...
                                                        <td class="calendar-date"><a>18</a></td>
                                                        <td class="calendar-date"><a>19</a></td>
                                                        <td class="calendar-date calendar-sat"><a>20</a></td>
                                                    </tr>
                                                    <tr class="calendar-week"> <!-- 달력의 한 주에 해당하는 엘리먼트 컨테이너 -->
                                                        <td class="calendar-date calendar-sun"><a>21</a></td>
                                                        <!-- 날짜가 표시될 엘리먼트 -->
                                                        <td class="calendar-date">22</td>
                                                        <td class="calendar-date"><a>23</a></td>
                                                        <td class="calendar-date"><a>24</a></td>
                                                        <td class="calendar-date"><a>25</a></td>
                                                        <td class="calendar-date"><a>26</a></td>
                                                        <td class="calendar-date calendar-sat"><a>27</a></td>
                                                    </tr>
                                                    <tr class="calendar-week"> <!-- 달력의 한 주에 해당하는 엘리먼트 컨테이너 -->
                                                        <td class="calendar-date calendar-sun"><a>28</a></td>
                                                        <!-- 날짜가 표시될 엘리먼트 -->
                                                        <td class="calendar-date">29</td>
                                                        <td class="calendar-date"><a>30</a></td>
                                                        <td class="calendar-date"><a>31</a></td>
                                                        <td class="calendar-date calendar-next-mon"><a>1</a></td>
                                                        <td class="calendar-date calendar-next-mon"><a>2</a></td>
                                                        <td class="calendar-date calendar-next-mon calendar-sat"><a>3</a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
